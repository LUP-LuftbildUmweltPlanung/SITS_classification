...
sampling_params = {
    ###BASIC PARAMS###
    "project_name": "uge_vc_30m_equalized", #Project Name that will be the name of the output folder in temp & result subfolder
...
extract_param = {
    "raster_path" : sorted(glob.glob(r"/uge_mount/FORCE/new_struc/process/data/phd_publi1/ref_data/+vegetation_cover/*.tif")),
    "column_name" : "vc", #attribute column name to store the response variable
    }

...
args_predict = {
    ...
    'model_path': '/uge_mount/FORCE/new_struc/process/results/_SITSModels/test_updated_code/transformer/model_e53.pth', # Path to Model
    'aois': glob.glob(f"/uge_mount/FORCE/new_struc/process/data/sits_class/xhain_2023.shp"), # aois can be path or list. Path for Force Tile folder or list // process structure and shapefiles must be correct
    #'aois': None,

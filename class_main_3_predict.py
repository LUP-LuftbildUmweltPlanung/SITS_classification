...
args_predict = {
    'project_name': "multi_tile",
    "process_folder": "/uge_mount/FORCE/new_struc/process/",
    'model_path': '/uge_mount/FORCE/new_struc/process/results/_SITSModels/class_seal_3years/transformer/model_e120.pth', # Path to Model
    'aois': glob.glob("/uge_mount/FORCE/new_struc/process/data/sealed/test_multitile_2023.shp"), # aois can be path or list. Path for Force Tile folder or list // process structure and shapefiles must be correct
    #'aois': None,
